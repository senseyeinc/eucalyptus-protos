...
_STATUS = _descriptor.Descriptor(
  name='Status',
  full_name='senseye.Status',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='senseye.Status.code', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='message', full_name='senseye.Status.message', index=1,
...
Status = _reflection.GeneratedProtocolMessageType('Status', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:senseye.Status)
  })
